...
godot::PackedInt32Array GizmoTest::_subgizmos_intersect_frustum( godot::Camera3D *camera,
                                                   const godot::TypedArray<godot::Plane> &frustum )
const
{
...
void GizmoTest::_commit_subgizmos( const godot::PackedInt32Array &ids, const
godot::TypedArray<godot::Transform3D> &restores, bool cancel )
{
